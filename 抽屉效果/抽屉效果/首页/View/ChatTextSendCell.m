...
@implementation ChatTextSendCell
...
- (WechatView *)chatView {
    if (!_chatView) {
        _chatView = [[WechatView alloc] initWithMessageType:MessageType_Text messageDerection:MessageDerection_Send];
    }
    return _chatView;
}
